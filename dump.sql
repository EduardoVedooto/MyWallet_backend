...
--
-- Data for Name: finances; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Name: finances_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.finances_id_seq', 17, true);
